...
const Profile = () => {
    ...
    const name = auth?.currentUser?.displayName || 'No name set';

    return (
        <SafeAreaView className="flex-1 bg-gray-100 items-center">
            {/* Profile Avatar  */}
            <View className="relative items-center mt-5 mb-2.5">
                <TouchableOpacity className="w-32 h-32 rounded-full items-center justify-center bg-blue-600" onPress={handleShowProfilePicture}>
            ...
            <View className="mt-10 w-11/12">
                <Cell
                    ...
                    className="mb-3.5 py-3 px-2.5 bg-white rounded-lg shadow-sm"
                />
